...
import '/user_side/product_info/product_info_widget.dart';
                            ...
                            children: [
                              Align(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.network(
                                    'https://i.pinimg.com/564x/3e/62/fd/3e62fd2e7aae73528939e204c7181c9b.jpg',
                                    width: double.infinity,
                                    height: 260.0,
                                    fit: BoxFit.cover,
                                  ),
                          ...
                          Row(
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: Image.network(
                                  'https://images.unsplash.com/photo-1619454016518-697bc231e7cb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxsb2dvfGVufDB8fHx8MTcyNTg5MjQxOHww&ixlib=rb-4.0.3&q=80&w=1080',
                                  width: 35.0,
                                  height: 35.0,
                                  fit: BoxFit.cover,
                                ),
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ProductInfoWidget(
                                          key: Key(
                                              'Keygjj_${listViewIndex}_of_${listViewFoodItemRecordList.length}'),
                                          foodItem: listViewFoodItemRecord,
                                        ),
                                      ],
                                    ),
                                  ),
