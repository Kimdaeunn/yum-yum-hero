...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF6507);
  late Color secondary = const Color(0xFFF2F2F2);
  late Color tertiary = const Color(0xFFB2B4B6);
  late Color alternate = const Color(0xFFE1E0E0);
  late Color primaryText = const Color(0xFF101213);
  late Color secondaryText = const Color(0xFF7A7D7F);
  late Color primaryBackground = const Color(0xFFF9FAFC);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFF8F8F8);
